(function(factory) {
    ...
    _e(function(E, $) {
        ...
        Txt.fn.bindPasteFilter = function() {
            ...
            var isParseHtmlTags = editor.config.isParseHtmlTags;
            ...
            editor.xhrUploadImg = function(opt) {
                ...
                var wangEditorAjax = $.ajax({
                    ...
                    error: function(err) {
                        ...
                        errorfn && errorfn.call(editor, err);
