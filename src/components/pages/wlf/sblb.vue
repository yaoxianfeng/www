...
<div class="cs_shangbao">
  <div class="sblb">
    ...
    <el-row class="details" v-for="obj in namelist"  :key="obj.id">
      <el-col :span="2" :offset="2"><input type="checkbox"></el-col>
      <el-col :span="4" :offset="1"><div class="fm_name">{{obj.fm_name}}</div></el-col>
      <el-col :span="8"><div class="_status">{{obj._status}}</div></el-col>
      <el-col :span="5" :offset="2"><div class="_fasong"><img src="/static/img/u1565.png" alt=""></div></el-col>
    </el-row>
  </div>
