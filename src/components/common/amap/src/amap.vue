<template>
<div class="ha-vue-amap-container">
    <div class="ha-vue-amap"></div>
    <slot></slot>
</div>
</template>
  <script>
     ...
     methods: {
       ...
       createMap() {
         this._loadPromise.then(() => {
           let mapElement = this.$el.querySelector('.ha-vue-amap');
...
<style>
.ha-vue-amap-container {
  height: 100%;
  overflow: hidden;
}
.ha-vue-amap-container .ha-vue-amap {
  height: 110%;
}
</style>
